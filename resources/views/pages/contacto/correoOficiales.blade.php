<x-layout bodyClass="g-sidenav-show bg-gray-200">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        ...
        <div class="container-fluid py-4">
            <header>
                <center>
                    <h1>Enviar correo a los Oficiales</h1>
                </center>
                <a class="btn btn-success" href="{{route ('email_admin')}}">Enviar correo a los usuarios</a>
            </header>
            <main>
                <center>
                        ...
                        <div>
                            ...
                            <select id="correo_destino_select" name="correo_destino[]" multiple="multiple"
                                ...
                                @foreach($oficiales as $oficial)
                                    <option value="{{ $oficial->email }}">{{ $oficial->email }}</option>
                                @endforeach
                            </select>
