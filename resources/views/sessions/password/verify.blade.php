                        ...
                        <div class="card z-index-0 fadeIn3 fadeInBottom">
                            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                                <div class="bg-gradient-success shadow-primary border-radius-lg py-3 pe-1">
                                    <h4 class="text-white font-weight-bolder text-center mt-2 mb-0">Cambiar Contraseña
                                    </h4>
                            ...
                            <div class="card-body">
                                ...
                                <form role="form" method="POST" action="{{ route('verify') }}" class="text-start">
                                    ...
                                    <div class="text-center">
                                        <button type="submit"
                                            class="btn bg-gradient-success w-100 my-4 mb-2">Enviar</button>
                                    </div>
                                    <p class="mt-4 text-sm text-center">
                                        ¿No tienes una cuenta?
                                        <a href="{{ route('register') }}"
                                            class="text-success text-gradient font-weight-bold">Crear Cuenta</a>
                                    </p>
                                </form>
                            </div>
                        </div>
